    ...
    <Card.Body>
      ...
      <Card.Text>
        {recipes.healthLabels.includes("Alcohol-Free") && (
          <Card.Img src={alcool} alt="Alcohol-Free" title="Alcohol-Free" />
        )}
